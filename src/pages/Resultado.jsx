      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-2xl shadow-lg text-white relative overflow-hidden flex flex-col h-full">
          ...
          <div className="space-y-3 text-sm flex-1 border-t border-gray-700 pt-3">
            ...
            <div className="flex justify-between">
              <span className="text-gray-400">TIR (Tasa Interna de Retorno):</span>
              <span className={`font-semibold ${indicadores.tir > plan.cok ? 'text-green-400' : 'text-yellow-400'}`}>
                {formatPercent(indicadores.tir)}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400">Duración:</span>
              <span className="font-semibold text-white">{Number(indicadores.duracion).toFixed(2)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400">Convexidad:</span>
              <span className="font-semibold text-white">{Number(indicadores.convexidad).toFixed(2)}</span>
            </div>
          </div>
